...
result_dir = "paper1/Results/Embeddings/embedding_results_temporal.pkl"
...
loc = "paper1/Results/Embeddings/test_data/fintextsim_2016_2023_triplet_temporal.pkl"
...
dr_embeddings = data["basics"]["test_embeddings_ots3"]


embeddings = [fts_modernbert_embeddings, am_embeddings, mpnet_embeddings, dr_embeddings]
model_locs = [
...
model_names = ["FinTextSim", "AM", "MPNET", "DR"]
