...
result_dir = "paper1/Results/BERTopic_Models/bertopic_results.pkl"
result_dict = {}
result_dict["config"] = {
    "n_topic_words": 5,
...
#---------Load embeddings
loc = "paper1/Data/topic_model_input/embeddings_2016_2023.pkl"

with open(loc, "rb") as file:
    data = pickle.load(file)

embeddings_acl_modern_bert = data["acl_modern_bert"]
embeddings_htl_modern_bert = data["htl_modern_bert"]
embeddings_am = data["AM"] 
embeddings_mpnet = data["MPNET"]
...
model_locs = [
    "paper1/Topic_Models/BERTopic/bertopic_acl_modern_bert", "paper1/Topic_Models/BERTopic/bertopic_htl_modern_bert",
    "paper1/Topic_Models/BERTopic/bertopic_AM", "paper1/Topic_Models/BERTopic/bertopic_MPNET"
]

model_names = [
    "bertopic_acl_modern_bert", "bertopic_htl_modern_bert",
    "bertopic_AM", "bertopic_MPNET"
]

embeddings = [
    embeddings_acl_modern_bert, embeddings_htl_modern_bert,
    embeddings_am, embeddings_mpnet
]
