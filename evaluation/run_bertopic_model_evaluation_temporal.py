...
result_dir = "paper1/Results/BERTopic_Models/bertopic_results_temporal.pkl"
...
#---------Load embeddings
loc = "paper1/Data/topic_model_input/embeddings_2016_2023_temporal.pkl"

with open(loc, "rb") as file:
    data = pickle.load(file)

embeddings_htl_modern_bert_masked = data["htl_temporal"]
...
model_locs = [
    "paper1/Topic_Models/BERTopic/bertopic_htl_temporal",
...
model_names = [name.split("bertopic_")[1] for name in model_locs]

embeddings = [
    embeddings_htl_modern_bert_masked,
    embeddings_am, 
    embeddings_mpnet,
