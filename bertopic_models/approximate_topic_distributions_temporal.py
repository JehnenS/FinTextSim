...
result_loc = "paper1/Results/BERTopic_Models/topic_probabilities_classifier_masked.pkl"
...
model_names = [name.split("bertopic_")[1] for name in bertopic_model_locs]
 ...
 #   print(f"model_loc: {tm_loc}")
  #  print(f"Model name: {model_names[i]}")
   ...
   # tm = BERTopic.load(tm_loc)
    #topic_distributions, topic_token_distributions = tm.approximate_distribution(texts, use_embedding_model = False, batch_size = 100000) #set use_embedding_model to false --> no direct embedding model for classifiers
