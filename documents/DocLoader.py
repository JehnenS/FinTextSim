...
class DocLoader:
    ...
    def __init__(self, 
                 ...
                 output_dir = "paper1/Data/10-K/", #directory where to save the docs and metadata
    ...
    def load_data_from_zip(self, zip_path):
        """
    ...
    def run_extraction(self):
        ...
        for zip_path in zip_paths:
            docs, metadata = self.load_data_from_zip(zip_path) #iterate over all zip paths, extract documents and metadata + save them in directory
