...
### Define save loc
save_loc = "paper1/Data/Features/fin_features.csv"
save_loc_swade = "paper1/Data/Features/swade_features.csv"

#---------Load data
data_loc = "paper2/Data/FMP/fmp_data_cik_symbol.pkl"
...
#stock_df = creator._winsorize_stock_df(stock_df, percentile_low = 0.01, percentile_high = 0.99)
...
from feature_creation.utils_feature_creation import safe_divide
full_features_incl_stock["market_leverage"] = safe_divide(full_features_incl_stock["bs_abs_totalDebt"], full_features_incl_stock["bs_abs_totalDebt"] + full_features_incl_stock["km_marketCap"]
)
full_features_incl_stock["gp_to_assets"] = safe_divide(full_features_incl_stock["is_abs_grossProfit"], full_features_incl_stock["bs_abs_totalEquity"])
full_features_incl_stock["net_income_to_equity"] = safe_divide(full_features_incl_stock["is_abs_netIncome"], full_features_incl_stock["bs_abs_totalEquity"])
full_features_incl_stock["net_income_to_assets"] = safe_divide(full_features_incl_stock["is_abs_netIncome"], full_features_incl_stock["bs_abs_totalAssets"])
full_features_incl_stock["share_turnover"] = safe_divide(full_features_incl_stock["mean_volume"], full_features_incl_stock["is_abs_weightedAverageShsOut"])
